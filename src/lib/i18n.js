...
const DICT = {
  it: {
    ...
    'rules.coverageDesc': 'Quante persone servono per ogni turno, distinguendo giorni feriali da weekend/festivi. La generazione prova a coprire questi numeri e segnala i giorni scoperti.',
  ...
  en: {
    ...
    'rules.coverageDesc': 'How many people each shift needs, distinguishing weekdays from weekends/holidays. Generation tries to meet these numbers and flags uncovered days.',
